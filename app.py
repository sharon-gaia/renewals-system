...
POLICY_WA_RENEWAL = (
    ...
    'אם מעניין אותך לשמוע איך אפשר להגן גם עליך אישית באופן אישי (אם קורה לך אישית משהו) '
    'ולא רק על העסק, אפשר להשיב להודעה "מעניין" ואדאג שיחזרו אליך בהקדם, בלי שום התחייבות. 😊'
)
